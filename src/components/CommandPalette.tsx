  ...
  const allItems: PaletteItem[] = useMemo(() => {
    const items: PaletteItem[] = [
      // Sections
      {
        ...
        subtitle: 'Shema Philbert Gasana · Software Engineer',
        action: () => navigateTo('#hero'),
      },
      {
        id: 'nav-about',
        title: '01 — Introduction & A Thought',
        category: 'Navigation',
        icon: <User size={16} />,
        subtitle: 'Background & core engineering thought',
        action: () => navigateTo('#about'),
      },
      {
        id: 'nav-what-i-do',
        title: '02 — What I Build & 10 — Why I Build',
        category: 'Navigation',
        icon: <Command size={16} />,
        subtitle: 'Full-Stack, Backend, DevOps, Products & Focus areas',
        action: () => navigateTo('#nscodex'),
      },
      {
        id: 'nav-capabilities',
        title: '03 — Technologies (The Tools I Speak)',
        category: 'Navigation',
        icon: <Layers size={16} />,
        subtitle: 'Languages, Frontend, Backend, Databases, DevOps & Cloud',
        action: () => navigateTo('#capabilities'),
      },
      {
        id: 'nav-projects',
        title: '04 — Selected Work (Project Catalog)',
        category: 'Navigation',
        icon: <FolderGit2 size={16} />,
        subtitle: 'Bulk Email App, Site Track, Health Sphere & products',
        action: () => navigateTo('#projects'),
      },
      {
        id: 'nav-protocols',
        title: '07 — Beyond Code / Infrastructure Pipeline',
        category: 'Navigation',
        icon: <Activity size={16} />,
        subtitle: 'GitLab CI/CD, Docker, Kubernetes, IaC & Cloud',
        action: () => navigateTo('#protocols'),
      },
      {
        id: 'nav-timeline',
        title: '05 — Journey, 06 — Exp & 08 — Education',
        category: 'Navigation',
        icon: <Compass size={16} />,
        subtitle: 'Engineering journey, experience at Click Creations & AUCA',
        action: () => navigateTo('#timeline'),
      },
      {
        id: 'nav-documentation',
        title: '12 — Library, 13 — Soundtrack & 15 — Archive',
        category: 'Navigation',
        icon: <BookOpen size={16} />,
        subtitle: 'Engineering notes, reading library & soundtrack',
        action: () => navigateTo('#documentation'),
      },
      {
        id: 'nav-contact',
        title: '16 — Direct Contact & Let\'s Build',
        category: 'Navigation',
        icon: <Mail size={16} />,
        subtitle: 'Email, GitHub, LinkedIn profiles',
      ...
      {
        id: 'act-github',
        title: 'Open GitHub Profile (@shemaphilbert)',
        category: 'Actions',
          ...
          >
            ...
            >
              ...
              <input
                ...
                placeholder="Search projects, technologies, experience, or jump to section..."
                style={{
                  width: '100%',
